...
class TestWarning(WorkerTestBase):
    async def test_hashcat_warning(self):
        ...
        self.hashcat.get_warning.return_value = "TEST_WARNING"
        self.assertEqual((await self.worker.poll())["warning"], "TEST_WARNING")
